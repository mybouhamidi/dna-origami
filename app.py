...
class DNA_origami(QWidget):
    ...
    def run_randomization(self):
        if self.highlighted == []:
            ...
            self.randomize_validate_randomization(params, new_maximum, current_max)
    ...
    def randomize_validate_randomization(self, params, new_maximum, current_max):
        for iteration in range(LIMIT_OF_TRIALS):
            ...
            while counter < len(self.highlighted):
                ...
                if (gci / self.population_size[self.index[counter]]) < self.gc_min or (
                    ...
                    if self.header[self.index[counter]] in self.fixed_regions.keys():
                        error = QErrorMessage(self)
                        error.showMessage(
            ...
            if self.iterator <= 0:
                ...
                for count in range(self.iterator):
                    ...
                    self.randomize_validate_randomization(
                        params, new_maximum, current_max
                    )
